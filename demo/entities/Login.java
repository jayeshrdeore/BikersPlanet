...
public class Login {
	...
	public Login(int id, String email, String password, String answer, Question question,CustomerType role_id) {
		super();
		this.id = id;
		this.email = email;
		this.password = password;
	...
	public CustomerType getRole_id() {
		return role_id;
	}

	public void setRole_id(CustomerType role_id) {
		this.role_id = role_id;
	}
